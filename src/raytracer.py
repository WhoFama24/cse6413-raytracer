...
# with open('/models/mini_geometry.json', 'r') as json_file:
#     geometry_data = json.load(json_file)
# with open('/models/mini_material.json', 'r') as json_file:
#     material_data = json.load(json_file)
#
# with open('/models/bounding_box.json', 'r') as json_file:
#     geometry_data = json.load(json_file)
# with open('/models/bounding_material.json', 'r') as json_file:
#     material_data = json.load(json_file)
...
for i in range(0, IMAGE_SIZE[0]):
    for j in range(0, IMAGE_SIZE[1]):
        ...
        printProgressBar((i+1)*(j+1), IMAGE_SIZE[0]*IMAGE_SIZE[1], prefix='Progress', suffix='Complete', length=100)
